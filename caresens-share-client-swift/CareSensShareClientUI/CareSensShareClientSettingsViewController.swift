//
//  CareSensShareClientSettingsViewController.swift
//  Loop
//
...
public class CareSensShareClientSettingsViewController: UITableViewController {

    public let cgmManager: CareSensShareClientManager
    ...
    public init(cgmManager: CareSensShareClientManager, displayGlucosePreference: DisplayGlucosePreference, allowsDeletion: Bool) {
