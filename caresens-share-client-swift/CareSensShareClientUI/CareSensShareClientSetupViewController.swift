//
//  CareSensShareClientSetupViewController.swift
//  Loop
//
...
class CareSensShareClientSetupViewController: UINavigationController, CGMManagerOnboarding, CompletionNotifying {
    weak var cgmManagerOnboardingDelegate: CGMManagerOnboardingDelegate?
    weak var completionDelegate: CompletionDelegate?

    let cgmManager = CareSensShareClientManager()
